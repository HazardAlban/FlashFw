...
_Fw.Client_SkinChanger.getMaxValues = function()
...
_Fw.Client_SkinChanger.applySkin = function(skin)
    local playerPed = PlayerPedId()
...
_Fw.Client_SkinChanger.getCharacter = function()
    return (Character)
end

_Fw.Client_SkinChanger.setAllToDefault = function()
    local newCharacter = {}
    for k, v in pairs(components) do
        newCharacter[v.name] = v.value
    end
    _Fw.Client_SkinChanger.applySkin(newCharacter)
    ClearPedProp(PlayerPedId(), 0)
    ClearPedProp(PlayerPedId(), 1)
end

_Fw.Client_SkinChanger.setCharacterValueWithoutChange = function(key, value)
    Character[key] = value
end

_Fw.loadedComponent("skinchanger")